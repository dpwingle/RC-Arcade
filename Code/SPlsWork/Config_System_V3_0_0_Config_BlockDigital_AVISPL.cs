...
namespace UserModule_CONFIG_SYSTEM_V3_0_0_CONFIG_BLOCKDIGITAL_AVISPL
{
    public class UserModuleClass_CONFIG_SYSTEM_V3_0_0_CONFIG_BLOCKDIGITAL_AVISPL : SplusObject
    {
...
public UserModuleClass_CONFIG_SYSTEM_V3_0_0_CONFIG_BLOCKDIGITAL_AVISPL ( string InstanceName, string ReferenceID, Crestron.Logos.SplusObjects.CrestronStringEncoding nEncodingType ) : base( InstanceName, ReferenceID, nEncodingType ) {}
